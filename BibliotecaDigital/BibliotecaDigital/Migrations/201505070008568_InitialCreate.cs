namespace BibliotecaDigital.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Emprestimoes", "Livro_Id", "dbo.Livroes");
            DropForeignKey("dbo.Emprestimoes", "Aluno_Id", "dbo.Alunoes");
            ...
            DropIndex("dbo.Emprestimoes", new[] { "Livro_Id" });
            DropIndex("dbo.Emprestimoes", new[] { "Aluno_Id" });
